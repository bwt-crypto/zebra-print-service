...
powershell -NoProfile -Command "Compress-Archive -Path 'dist\ZebraPrint.exe' -DestinationPath 'dist\ZebraPrint-v%APP_VERSION%.zip' -Force"

echo.
echo Ready: dist\ZebraPrint.exe
